...
const View = props => {
  ...
  console.log('receiptsssss', receiptList);
  return (
    <div>
      <Card style={{ width: '80%', margin: 'auto', boxShadow: '2px 2px 10px #000' }}>
        <Card.Body>
          <Card.Title>
            Details of <em>"{receiptList.amount}"</em>
            <Button
              style={{ float: 'right' }}
          ...
          <Form>
            <Form.Row>
              <Form.Group as={Col} controlId="formGridName">
                ...
                <div>
                  <Form.Label>
                    {receiptList.firstName + ' ' + receiptList.lastName}
                  </Form.Label>
                </div>
              </Form.Group>
            </Form.Row>
          ...
          {/* <Form.Group as={Col} controlId="formGridEmail">
                ...
                <div>
                  <Form.Label>{receiptList.email}</Form.Label>
                </div>
              </Form.Group>
            </Form.Row>
            <hr />
            ...
            <Form.Row id="formGridCheckbox">
              <div className="custom-control custom-checkbox mb-3">
                <input
                  ...
                  id="customCheck"
                  name="example1"
                  checked={receiptList.isIndividual}
                />
